...
void
reset_cursor_mode (xfwmWaylandCompositor *server)
{
...
static void
process_cursor_move (xfwmWaylandCompositor *server, uint32_t time)
{
...
static void
process_cursor_resize (xfwmWaylandCompositor *server, uint32_t time)
{
    /*
...
static void
process_cursor_motion (xfwmWaylandCompositor *server, uint32_t time)
{
...
static void
handle_cursor_request (struct wl_listener *listener, void *data)
{
...
xfwmCursor *
cursor_create (xfwmWaylandCompositor *server)
{
...
void
cursor_destroy (xfwmCursor *cursor)
{
    if (!cursor) {
        return;
    }
